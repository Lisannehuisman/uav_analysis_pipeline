...
def main() -> None:
    ...
    output_dir = workspace / "results" / "recomputed" / "viewpoint_training_strength"
    plots_dir = output_dir / "plots"
    ensure_dir(output_dir)
    ensure_dir(plots_dir)

    original_csv = workspace / "results" / "intermediate" / "per_image_metrics_model_b.csv"
    single_csv = workspace / "results" / "tables" / "single_view_sweep_master_results.csv"
