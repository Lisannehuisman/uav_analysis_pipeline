...
DEFAULT_PAIR_ROWS = WORKSPACE / "results" / "intermediate" / "pair_combo_rows.csv"
DEFAULT_TRIPLE_ROWS = WORKSPACE / "results" / "intermediate" / "triple_combo_rows.csv"
DEFAULT_OUTPUT_DIR = WORKSPACE / "results" / "recomputed" / "significance_tests"
