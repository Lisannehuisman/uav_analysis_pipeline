...
DEFAULT_GT = Path("outputs") / "detector_family_comparison" / "standardized_test_eval" / "ground_truth" / "M4_test_gt.json"
DEFAULT_PRED = Path("outputs") / "detector_family_comparison" / "standardized_test_eval" / "predictions" / "YOLOv8l_M4_test_predictions.json"
DEFAULT_OUTPUT_DIR = Path("m4_two_drone_operational_analysis") / "outputs"
