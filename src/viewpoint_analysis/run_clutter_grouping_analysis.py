...
DEFAULT_GEOMETRY_CSV = ROOT / "results" / "intermediate" / "view_geometry_table.csv"
DEFAULT_SCENE_RECORDS_CSV = ROOT / "results" / "intermediate" / "scene_view_records.csv"
DEFAULT_OUTPUT_DIR = ROOT / "results" / "recomputed" / "clutter_grouping"
