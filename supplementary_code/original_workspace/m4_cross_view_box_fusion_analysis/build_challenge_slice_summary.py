...
DEFAULT_GT_JSON = (
    ROOT / "outputs" / "detector_family_comparison" / "standardized_test_eval" / "ground_truth" / "M4_test_gt.json"
)
DEFAULT_OUTPUT_DIR = ROOT / "m4_cross_view_box_fusion_analysis" / "outputs"
