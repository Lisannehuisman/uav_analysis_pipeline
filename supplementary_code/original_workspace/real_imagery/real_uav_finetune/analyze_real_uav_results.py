...
def main() -> None:
    out_dir = RUN_ROOT / "analysis_outputs"
    ...
    report = [
        ...
        "",
        "The class order used by these runs is the order in real_imagery/review_sets/new_dataset/data.yaml, not the root data.yaml.",
